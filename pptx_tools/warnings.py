...
HEADING_INLINED = "heading_inlined"
...
TABLE_WIDTHS_IGNORED = "table_widths_ignored"
TABLE_FILL_IGNORED = "table_fill_ignored"
TABLE_MERGE_IGNORED = "table_merge_ignored"
...
WARNING_SEVERITY: Dict[str, str] = {
    ...
    CONTROL_CHARS_REMOVED: SEVERITY_INFO,
    ...
    COLUMN_DROPPED: SEVERITY_ERROR,
    COLUMNS_MERGED: SEVERITY_WARNING,
    HEADING_INLINED: SEVERITY_INFO,
    ...
    TABLE_WIDTHS_IGNORED: SEVERITY_WARNING,
    TABLE_FILL_IGNORED: SEVERITY_WARNING,
    TABLE_MERGE_IGNORED: SEVERITY_WARNING,
