...
:mod:`~admin.views.settings` for the server-wide style mapping,
...
from admin.views.settings import global_styles_page
...
__all__ = [
    ...
    "not_found_page",
    "page", "pptx_analysis_report", "preview_values_page",
    "global_styles_page", "refresh_seconds", "replace_card",
    "save_failed_page",
